...
for root, _, files in os.walk(rna_dir):
    for f in files:
        ...
        with open(file_path) as file:
            ...
            # Parse filename to get miRNA + contig + coords
...
# --- Filter: Only keep rows where binding is inside target region ---
rna_df_filtered = rna_df[(rna_df["pos1"] > 150) & (rna_df["pos2"] < 186)]

# --- Convert key columns to consistent types for merge ---
...
print("Merging finalresults with RNAup info...")
