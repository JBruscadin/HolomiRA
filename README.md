...
**2-** Customize HoloMirA by editing the configuration file ([config.yaml])([path_to_config.yaml](https://github.com/JBruscadin/HolomiRA/blob/main/config.yaml) with your preferred text editor. 
